# Prepared quote request — not sent

Recipient: SteelMart Gainesville, via its [quote form](https://steelmartatlanta.com/steelmart-gainesville-ga/).

Subject: Raw material quotation for owner-fabricated CNC table — delivery to Alto, GA 30510

Please quote the raw materials below for a small CNC table. I will perform the cutting, machining, welding and finishing. Please do not include fabrication labor. This is a quotation request only, not an order.

Delivery destination: 140 Mt Zion Church Road, Alto, GA 30510. Please itemize material, any mandatory stock-length cuts, delivery/handling, tax and lead time. Please identify any unloading equipment or site access requirements. Price full-length tube delivery without transport cuts; the planned cut patterns depend on the full lengths. State any delivery minimum.

Please quote only the material lines you supply. Show economical stock-size alternatives separately, with actual grade, thickness and dimensions. The listed metric finished dimensions are design requirements, so any proposed substitution needs review before purchase.

| Qty | Raw material requested | Purpose / note |
|---:|---|---|
| 6 | A500 square tube, 2 × 2 × .120 in, full 20 ft bars | Chassis and removable bed beams; no blanket 10 ft transport cuts |
| 1 | Square tube, 1 × 1 × .083 in, full 20 ft bar | Frame braces |
...
| 1 | A36 plate, 1/4 × 24 × 48 in | Frame flats, gussets and mounting pieces |
...
| 4 | 6061-T6511 flat bar, 1/4 × 1 × 72 in | Bed ties |
