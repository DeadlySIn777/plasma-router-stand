...
def run(kind):
    ...
    def completed_builder(*args, **kwargs):
        ...
        details["structure_finish"]=structure_finish.extend_router_model(model)
        prepare(model)
    ...
    result['revision'] = 'Rev H plus structure reinforcement, original prescribed large-part route'
    ...
    print('REINFORCED_ROUTE', kind, 'PASS' if result['integrated_passed'] else 'FAIL',
