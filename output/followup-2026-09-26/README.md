...
- **Cost register re-baselined to Rev H.** Priced scope is now **$5,334.09** ($5,247.84 goods + $86.25 known shipping), 73 priced lines and 49 unpriced entries. The Rev G bed rows (MDF, ties, rack stock, N3, N5) are superseded, N1 is 48 stainless nuts, and the Rev H HDPE, stainless, lug bar, 8 ft tube and galvanizing rows are unpriced. The SteelMart request lists Rev H stock.
...
- Procurement: quotes for the 49 unpriced entries and freight (the SteelMart request is ready but unsent); rebuild the workbook; regenerate the concept PDF for Rev H.
