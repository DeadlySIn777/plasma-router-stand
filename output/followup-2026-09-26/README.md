...
- **Cost register re-baselined to Rev H.** Priced scope is now **$5,336.10** ($5,249.85 goods + $86.25 known shipping, including the $82 price the owner reported for the 1,200 mm rail kit), 73 priced lines and 49 unpriced entries. The Rev G bed rows (MDF, ties, rack stock, N3, N5) are superseded, N1 is 48 stainless nuts, and the Rev H HDPE, stainless, lug bar, 8 ft tube and galvanizing rows are unpriced. The SteelMart request lists Rev H stock.
